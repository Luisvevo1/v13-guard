...
module.exports = async (role) => {
    ...
    await role.delete({reason: `Guard tarafından tekrardan silindi.`});
      ...
      .setDescription(`${entry.executor} (\`${entry.executor.id}\`) tarafından \`${role.name}\` \`${role.id}\` isimli rolü oluşturuldu ve geri silinerek, yapan kişi yasaklandı. https://discord.gg/gjjHmhTFhY`)
    ]})
